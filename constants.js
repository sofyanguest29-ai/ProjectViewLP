...
// Backlog & Completed posisinya ditukar (sesuai revisi) - urutan array ini
// yang menentukan urutan kolom Kanban dan urutan dropdown status.
...
export const DEV_LOG_STATUS_COLORS = {
  Identify: { color: '#1d4ed8', bg: '#dbeafe' },
  Prioritize: { color: '#7c3aed', bg: '#ede9fe' },
  Improve: { color: '#b45309', bg: '#fef3c7' },
  Impact: { color: '#b91c1c', bg: '#fee2e2' },
  Maintain: { color: '#15803d', bg: '#dcfce7' },
}

export function devLogStatusMeta(status) {
  return DEV_LOG_STATUS_COLORS[status] ?? { color: '#374151', bg: '#f3f4f6' }
}
...
export const QUESTIONNAIRE = [
  {
    ...
    options: [
      { value: 1, label: 'Tidak mengubah business process, ada impact ke speed/cost/accuracy namun perubahan tidak signifikan' },
